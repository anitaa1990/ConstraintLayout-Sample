...
import com.an.constraintlayout.databinding.VideoListAdapterBinding;
...
public class VideoListAdapter extends RecyclerView.Adapter<VideoListAdapter.CustomViewHolder> {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        VideoListAdapterBinding itemBinding = VideoListAdapterBinding.inflate(layoutInflater, parent, false);
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        private final VideoListAdapterBinding binding;
        public CustomViewHolder(VideoListAdapterBinding binding) {
