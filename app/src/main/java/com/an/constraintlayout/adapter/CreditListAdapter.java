...
import com.an.constraintlayout.databinding.CreditListItemBinding;
...
public class CreditListAdapter extends RecyclerView.Adapter<CreditListAdapter.CustomViewHolder> {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        CreditListItemBinding itemBinding = CreditListItemBinding.inflate(layoutInflater, parent, false);
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        private CreditListItemBinding binding;

        public CustomViewHolder(CreditListItemBinding binding) {
